...
export default function Contact() {
  return (
    <div id="contact" className="mx-auto max-w-5xl mb-40">
      ...
      <div className="flex justify-center mt-8">
        <a
          ...
          type="button"
          className="rounded-md px-10 py-5 text-[#62f5d6] shadow-sm ring-1 ring-inset ring-[#62f5d6] transition ease-in-out duration-300 bg-white/0 hover:bg-[#8892B0] hover:text-white"
        >
          Say Hello
        </a>
      </div>
