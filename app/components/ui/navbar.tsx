'use client'
import { useIsClient } from "@/app/store/is-client-context";
...
const navigation = [
  { number: '01', name: 'About', href: '#', scrollId: 'about', current: false },
  { number: '02', name: 'Experience', href: '#', scrollId: 'experience', current: false },
  { number: '03', name: 'Work', href: '#', scrollId: 'projects', current: false },
  { number: '04', name: 'Contact', href: '#', scrollId: 'contact', current: false },
]
...
export default function Navbar() {
  ...
  let navbarClasses = 'bg-[#0B192F] fixed w-full z-50';
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'text-[#62f5d6]' : 'text-white hover:text-[#62f5d6]',
